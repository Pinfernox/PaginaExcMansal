                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          if (FFAppState().showDataGallery == true)
                            Container(
                              width: double.infinity,
                              height: double.infinity,
                              decoration: BoxDecoration(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          FFAppState().showDataGallery = false;
                                          setState(() {});
                                        },
                                      ),
                                    ),
